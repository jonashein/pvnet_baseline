...
import os
import numpy as np
from tools.monitor import MetricMonitor

def main(metrics_file):
    assert os.path.isfile(metrics_file), f"Invalid argument for metrics: {metrics_file}"

    monitor = MetricMonitor(filepath=metrics_file)
